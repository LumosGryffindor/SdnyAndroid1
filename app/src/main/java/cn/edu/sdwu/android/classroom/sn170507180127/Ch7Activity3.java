...
public class Ch7Activity3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        hashMap.put("imgea",R.drawable.imgea);
        list.add(hashMap);
         hashMap=new HashMap();
        hashMap.put("name","goods2");
        hashMap.put("price","507");
        hashMap.put("imgea",R.drawable.imgea);
        list.add(hashMap);
       hashMap=new HashMap();
        hashMap.put("name","goods3");
        hashMap.put("price","70");
        hashMap.put("imgea",R.drawable.imgea);
        list.add(hashMap);
        //实例化适配器
        simpleAdapter=new SimpleAdapter(this,list,R.layout.layout_goods,new String[]{"name","price","imgea"},new int[]{R.id.goods_name,R.id.goods_price,R.id.goods_img});
        //设置到listview
